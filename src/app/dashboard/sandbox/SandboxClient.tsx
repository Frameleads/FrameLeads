  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 min-h-[calc(100vh-8rem)] lg:h-[calc(100vh-8rem)] relative">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4 min-h-[300px] lg:min-h-0 lg:h-full">
        ...
        {/* Tier Quota Header */}
        <div className="rounded-2xl border border-primary/30 bg-primary/10 p-5 md:p-6 mb-4 md:mb-6 flex items-center justify-between shadow-lg shadow-primary/5 shrink-0">
